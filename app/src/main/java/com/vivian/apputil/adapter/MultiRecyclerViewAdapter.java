 ...
 * Version: 1.0
 */
public abstract class MultiRecyclerViewAdapter<T> extends RecyclerView.Adapter<MultiRecyclerViewAdapter.BaseViewHolder> {
    ...
    @Override
    public void onBindViewHolder(MultiRecyclerViewAdapter.BaseViewHolder holder, final int position) {
