package com.vivian.apputil.widget.button;
...
import com.vivian.apputil.widget.listener.TypeListener;
...
public class CaptureLayout extends FrameLayout {
    ...
    private CameraProgressBar.OnProgressTouchListener captureLisenter;    //拍照按钮监听
    ...
    public void setCaptureLisenter(CameraProgressBar.OnProgressTouchListener captureLisenter) {
        this.captureLisenter = captureLisenter;
    }

    public CameraProgressBar getBtn_capture() {
        return btn_capture;
    }
    ...
    private CameraProgressBar btn_capture;      //拍照按钮
